/* Passive drone behaviors
 *
 * Passive drones will act as guards around their current position
 * They may move around the area while looking for targets, or remain completely stationary
 * Passive drones will not actively pursue targets and will disengage once line of sight has been broken
 * 
 * Passive drones are best used for mobile sentry guns
 */

void Passive_SimulateIdle(FDroneAI ai, FDroneSeat seat, ADrone drone, bool thinkTick)
{
...
void Passive_SimulateAttack(FDroneAI ai, FDroneSeat seat, ADrone drone, ADroneWeapon weapon, FDroneAIParams params, bool thinkTick)
{
